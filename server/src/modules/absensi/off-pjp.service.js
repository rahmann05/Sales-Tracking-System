...
/**
 * Sales submits an off-PJP attendance (visit to outlet outside today's plan).
 */
...
/**
 * List off-PJP attendances. Sales only sees their own; Supervisor/Admin see all.
 */
...
/**
 * Supervisor validates (approves or rejects) an off-PJP attendance.
 */
export const validateOffPjpAttendance = async (id, supervisorId, approved, rejectionNote) => {
  ...
  // Notify the sales user of the decision
